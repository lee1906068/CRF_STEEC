...
useful_tags_node = ["ref", "highway", "street_count", "geometry_xy"]
useful_tags_way = [
    "bridge",
    "tunnel",
    "oneway",
...
oneway_values = {"yes", "True", "true", "1", "-1", "reverse", "T", "F"}
reversed_values = {"0", "-1", "reverse", "T"}

# tags and attributes for generating an OSM XML file
osm_xml_node_attrs = ["id", "timestamp", "uid",
                      "user", "version", "changeset", "lat", "lon"]
